...
// - 프로그램 로딩 시점(main메서드 시작 전)에 메모리에 생겨남.
...
public class ModifierMain07 {
    ...
    public static void main(String[] args) { // 객체생성없이 main을 호출해 실행하기 위해 main 앞에는 static이 붙어야한다. 
        // static 멤버(변수, 메서드)는 클래스 이름으로 접근해서 사용.
