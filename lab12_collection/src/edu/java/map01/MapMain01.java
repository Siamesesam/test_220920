 ...
 * List<E>: 인덱스가 있다. 저장하는 순서가 중요. 중복된 값들을 저장할 수 있다.
 * Set<E>: 인덱스가 없다. 중복된 값들을 저장할 수 없다.
 * 
 * ArrayList<E>: get 속도 빠름. add/remove 속도는 느림.
 * LinkedList<E>: add/remove 속도 빠름. get 속도는 느림.
 * 
 ...
 *  1) Key: 중복된 값을 가질 수 없다. 리스트의 인덱스와 비슷한 역할. 생성시 반드시 1,2,3,... 순서대로 할 필요는 X
 *     Key의 역할은 데이터를 저장/검색/수정/삭제할 때 값을 찾기 위한 용도
 *  2) Value: 중복된 값을 가질 수 있다.
...
public class MapMain01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(map.getOrDefault(1, "Unonown"));
        System.out.println(map.getOrDefault(2, "Unonown"));
