...
public class GenericMain02 {
    ...
    public static void main(String[] args) {
        ...
        // -> put(Fruit fruit) 메서드를 호출할 때 전달하는 argument는 Fruit 타입 객체 뿐만 아니라, fruit를 상속하는 하위 타입 객체(예: Apple)도 전달할 수 있음.
        System.out.println(appleBox.get());
        // -> Fruit 타입을 리턴하는 메서드는 Fruit타입의 객체 뿐만 아니라 Fruit을 상속하는 하위 타입 객체(예: APple)도 리턴할 수 있음. 
