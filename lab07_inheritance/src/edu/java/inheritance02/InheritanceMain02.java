...
public class InheritanceMain02 {
    ...
    public static void main(String[] args) {
        ...
        // Person 타입 객체를 argument를 같는 생성자를 사용해서 생성.
        Person p2 = new Person("java");
        ...
        // superclass의 argument가 있는 생성자를 사용하려면 반드기 명시적으로 호출해야만 함! // 명시적으로 호출해야한다~~ 개발자가 직접 만들어라 ~~
        // super(...)를 호출하는 코드는 생성자에서 가장 먼저 작성되어야함!
        ...
        Student s3 = new Student("SQL", "JSP");
