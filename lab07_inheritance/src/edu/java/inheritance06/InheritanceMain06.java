...
public class InheritanceMain06 {
    ...
    public static void main(String[] args) {
        ...
        // -> 자바의 모든 클래스 Object 클래스의 public 멤버(변수, 메서드)를 상속받아서 사용, 재정의 가능.
        ...
        // 그 객체의toString() 메서드가 리턴해 주는 문자열들 콘솔창에 출력.
        ...
        System.out.println("equls() 메서드: " + p1.equals(p2));
        ...
        // 문자열이 같은 지를 비교할 때는 절대로 비교연산자(==, !=)를 사용하지 말고, equals() 메서드를 사용해서 비교!

        System.out.println("\n-----------------------\n");
        User u1 = new User("eornwlgns", "98763");
        User u2 = new User("eornwlgns", "123456789");
